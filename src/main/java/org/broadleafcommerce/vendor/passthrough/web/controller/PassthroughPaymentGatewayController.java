...
package org.broadleafcommerce.vendor.passthrough.web.controller;
 ...
 * This will handle translating the "fake response" from our PassthroughPaymentGateway
 ...
 */
@Controller("blPassthroughPaymentGatewayController")
@RequestMapping("/" + PassthroughPaymentGatewayController.GATEWAY_CONTEXT_KEY)
public class PassthroughPaymentGatewayController extends PaymentGatewayAbstractController {

    protected static final Log LOG = LogFactory.getLog(PassthroughPaymentGatewayController.class);
    protected static final String GATEWAY_CONTEXT_KEY = "passthrough-checkout";

    @Resource(name = "blPassthroughPaymentGatewayWebResponseService")
    ...
    public void handleUnsuccessfulTransaction(Model model, RedirectAttributes redirectAttributes,
        ...
        redirectAttributes.addAttribute(PAYMENT_PROCESSING_ERROR,
                responseDTO.getResponseMap().get(PassthroughPaymentGatewayConstants.RESULT_MESSAGE));
    }
