...
@Controller("blPassthroughPaymentGatewayCustomerPaymentController")
@RequestMapping("/" + PassthroughPaymentGatewayCustomerPaymentController.GATEWAY_CONTEXT_KEY)
public class PassthroughPaymentGatewayCustomerPaymentController extends CustomerPaymentGatewayAbstractController {

    protected static final Log LOG = LogFactory.getLog(PassthroughPaymentGatewayCustomerPaymentController.class);
    protected static final String GATEWAY_CONTEXT_KEY = "passthrough-customer-payment";
