 ...
 */
@Controller("blPassthroughPaymentGatewayHostedController")
@RequestMapping("/" + PassthroughPaymentGatewayHostedController.GATEWAY_CONTEXT_KEY)
public class PassthroughPaymentGatewayHostedController extends PaymentGatewayAbstractController {

    protected static final Log LOG = LogFactory.getLog(PassthroughPaymentGatewayHostedController.class);
    protected static final String GATEWAY_CONTEXT_KEY = "passthrough-checkout";

    @Resource(name = "blPassthroughPaymentGatewayHostedWebResponseService")
