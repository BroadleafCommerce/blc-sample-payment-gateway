...
@Controller("blPassthroughPaymentGatewayCustomerPaymentOMSController")
@RequestMapping("/" + PassthroughPaymentGatewayCustomerPaymentOMSController.GATEWAY_CONTEXT_KEY)
public class PassthroughPaymentGatewayCustomerPaymentOMSController extends CustomerPaymentGatewayAbstractController {

    protected static final Log LOG = LogFactory.getLog(PassthroughPaymentGatewayCustomerPaymentOMSController.class);
    protected static final String GATEWAY_CONTEXT_KEY = "passthrough-customer-payment-oms";
