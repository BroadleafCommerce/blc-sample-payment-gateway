...
public class PassthroughPaymentGatewayHostedWebResponseServiceImpl extends AbstractPaymentGatewayWebResponseService {
    ...
    public PaymentResponseDTO translateWebResponse(HttpServletRequest request) throws PaymentException {
        ...
        responseDTO.successful(true)
                .completeCheckoutOnCallback(Boolean.parseBoolean(paramMap.get(PassthroughPaymentGatewayConstants.COMPLETE_CHECKOUT_ON_CALLBACK)[0]))
                .amount(amount)
                ...
                .responseMap(PassthroughPaymentGatewayConstants.RESULT_MESSAGE,
                        paramMap.get(PassthroughPaymentGatewayConstants.RESULT_MESSAGE)[0]);
