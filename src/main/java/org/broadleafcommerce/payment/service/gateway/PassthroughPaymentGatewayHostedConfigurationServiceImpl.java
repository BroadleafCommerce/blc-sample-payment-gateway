 ...
 */
@Service("blPassthroughPaymentGatewayHostedConfigurationService")
public class PassthroughPaymentGatewayHostedConfigurationServiceImpl extends AbstractPaymentGatewayConfigurationService {
    ...
    @Resource(name = "blPassthroughPaymentGatewayHostedRollbackService")
    ...
    @Resource(name = "blPassthroughPaymentGatewayHostedTransactionConfirmationService")
