 ...
 */
@Service("blPassthroughPaymentGatewayTransactionService")
public class PassthroughPaymentGatewayTransactionServiceImpl extends AbstractPaymentGatewayTransactionService implements FailureCountExposable {
    ...
    public PaymentResponseDTO capture(PaymentRequestDTO paymentRequestDTO) throws PaymentException {
        PaymentResponseDTO responseDTO = new PaymentResponseDTO(PaymentType.CREDIT_CARD, PassthroughPaymentGatewayType.NULL_GATEWAY);
