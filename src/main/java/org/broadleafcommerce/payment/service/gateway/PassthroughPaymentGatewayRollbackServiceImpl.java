 ...
 */
@Service("blPassthroughPaymentGatewayRollbackService")
public class PassthroughPaymentGatewayRollbackServiceImpl extends AbstractPaymentGatewayRollbackService {

    protected static final Log LOG = LogFactory.getLog(PassthroughPaymentGatewayRollbackServiceImpl.class);
