...
public class PassthroughPaymentGatewayHostedServiceImpl extends AbstractPaymentGatewayHostedService {
    ...
    public PaymentResponseDTO requestHostedEndpoint(PaymentRequestDTO requestDTO) throws PaymentException {
        PaymentResponseDTO responseDTO = new PaymentResponseDTO(PaymentType.THIRD_PARTY_ACCOUNT,
                ...
                .responseMap(PassthroughPaymentGatewayConstants.ORDER_ID, requestDTO.getOrderId())
                .responseMap(PassthroughPaymentGatewayConstants.TRANSACTION_AMT, requestDTO.getTransactionTotal())
                .responseMap(PassthroughPaymentGatewayConstants.HOSTED_REDIRECT_URL,
